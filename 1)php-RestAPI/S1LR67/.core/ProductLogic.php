...
class Productlogic
{
    ...
    public static function CheckImg()
    {
        ...
        $uploadfile = $_SERVER['DOCUMENT_ROOT'] . "/MARINA/img1/" . $_FILES['img_path']['name'];
    ...
    public static function EditImg($old_tmp_img_name)
    {
        ...
        $delFile = $_SERVER['DOCUMENT_ROOT'] . "/MARINA/img1/" . $old_tmp_img_name;
    ...
    public static function DeleteImage(int $id)
    {
        ...
        $file = $_SERVER['DOCUMENT_ROOT'] . "/MARINA/img1/" . $img_p;
        unlink($file);
